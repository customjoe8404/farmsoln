class CropApp {
  ...
  setupEventListeners() {
    ...
    ["location", "soil-type", "farm-size", "water-availability"].forEach(
      (id) => {
    ...
    container.innerHTML = `
            <div class="recommendations-grid">
                ${this.recommendations
                  .map(
                    (crop, index) => `
                    <div class="crop-card ${this.getSuitabilityClass(
                      crop.suitability
                    )}">
                        ...
                        <div class="crop-header">
                            ...
                            <span class="profit-badge ${
                              crop.profitability > 70 ? "high" : "medium"
                            }">
                                💰 ${Math.round(crop.profitability)}% ROI
                            </span>
                        </div>
                        <div class="suitability-score">${Math.round(
                          crop.suitability
                        )}% Match</div>
                        ...
                        <div class="crop-details">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="risk-${crop.risk_level}">${
                      crop.risk_level
                    }</span>
                            </div>
                            <div class="detail-item">
                        ...
                        <button class="btn-outline" onclick="cropApp.viewCropDetails('${
                          crop.name
                        }')">
                            View Details →
                        </button>
  ...
  viewCropDetails(cropName) {
    ...
    if (crop) {
      this.showNotification(
        `Details for ${cropName}: ${crop.ai_insights}`,
        "info"
      );
    }
  }
