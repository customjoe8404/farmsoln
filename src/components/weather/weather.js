    ...
    container.innerHTML = `
            <div class="weather-current">
                <div class="weather-main">
                    ...
                    <div class="weather-location">${weather.city}, ${
      weather.country
    }</div>
                </div>
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          this.showNotification(
            "Location detected! Fetching weather...",
            "info"
          );
  ...
  generateForecastDays() {
    ...
    for (let i = 1; i <= 5; i++) {
      ...
      days.push({
        ...
        icon: ["🌤️", "☀️", "🌧️", "⛅", "🌦️"][i % 5],
        temp: Math.round(
          this.currentWeather.temperature + (Math.random() * 4 - 2)
        ),
        desc: ["Partly Cloudy", "Sunny", "Light Rain", "Cloudy", "Showers"][
          i % 5
        ],
